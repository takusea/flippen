...
const GlobalNavigation: React.FC<Props> = (props: Props) => {
	return (
		<div className="grid grid-rows-[40px_1fr] grid-cols-[64px_1fr] w-screen h-screen bg-gray-100">
			<header className="relative row-span-1 col-span-full flex items-center justify-between">
				...
				<h1 className="absolute inset-0 w-fit h-fit m-auto">untitled.para</h1>
			</header>
			<nav className="row-span-2 col-span-1 flex flex-col items-center gap-1 pb-2 px-2">
				...
				<div className="h-px w-full mt-auto bg-gray-200" />
				<IconButton label="Settings" icon={IconSettings} size="large" />
			</nav>
			<div className="row-span-1 col-span-1 bg-white rounded-tl-xl border border-gray-200">
				{props.children}
			</div>
		</div>
	);
